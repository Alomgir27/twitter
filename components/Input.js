...
function Input() {
  ...
  return (
    ...
    overflow-y-auto scrollbar-hide  ${loading && "opacity-60"}`}>
        <img 
         ...
         <div className='w-full divide-y divide-gray-700'>
             <div className={`${selectedFile && "pb-7"} ${input && "space-y-2.5"}`}>
                 ...
                 {selectedFile && (
                     ...
                     [#292c26] bg-opacity-75 rounded-full flex items-center justify-center
                ...
                {!loading && (
                    <div className='flex itemd-center justify-between pt-2.5'>
